...
deltaDEFF_grid <- seq(-9, 9, by = 0.1) # length = 181
x <- cbind(train_cv1$deltaOEFF, train_cv1$deltaDEFF) # dim(584, 2)
K <- 1
N <- length(y) # N = 584
D <- dim(x)[2] # D = 2
n_grid = length(deltaOEFF_grid) # n_grid = 181
...
# train_cv1 <- Regular %>% filter(Date != 2013)
# test_cv1 <- Regular %>% filter(Date == 2013)
y <- train_cv2$Success # length = 584
deltaOEFF_grid <- seq(-9, 9, by = 0.1) # grid for prediction
deltaDEFF_grid <- seq(-9, 9, by = 0.1) # length = 181
x <- cbind(train_cv2$deltaOEFF, train_cv2$deltaDEFF) # dim(584, 2)
K <- 1
N <- length(y) # N = 584
D <- dim(x)[2] # D = 2
n_grid = length(deltaOEFF_grid) # n_grid = 181
...
# train_cv1 <- Regular %>% filter(Date != 2013)
# test_cv1 <- Regular %>% filter(Date == 2013)
y <- train_cv3$Success # length = 584
deltaOEFF_grid <- seq(-9, 9, by = 0.1) # grid for prediction
deltaDEFF_grid <- seq(-9, 9, by = 0.1) # length = 181
x <- cbind(train_cv3$deltaOEFF, train_cv3$deltaDEFF) # dim(584, 2)
K <- 1
N <- length(y) # N = 584
D <- dim(x)[2] # D = 2
n_grid = length(deltaOEFF_grid) # n_grid = 181
...
# train_cv1 <- Regular %>% filter(Date != 2013)
# test_cv1 <- Regular %>% filter(Date == 2013)
y <- train_cv4$Success # length = 584
deltaOEFF_grid <- seq(-9, 9, by = 0.1) # grid for prediction
deltaDEFF_grid <- seq(-9, 9, by = 0.1) # length = 181
x <- cbind(train_cv4$deltaOEFF, train_cv4$deltaDEFF) # dim(584, 2)
K <- 1
N <- length(y) # N = 584
D <- dim(x)[2] # D = 2
n_grid = length(deltaOEFF_grid) # n_grid = 181
...
y <- train_cv5$Success # length = 584
deltaOEFF_grid <- seq(-9, 9, by = 0.1) # grid for prediction
deltaDEFF_grid <- seq(-9, 9, by = 0.1) # length = 181
x <- cbind(train_cv5$deltaOEFF, train_cv5$deltaDEFF) # dim(584, 2)
K <- 1
N <- length(y) # N = 584
D <- dim(x)[2] # D = 2
n_grid = length(deltaOEFF_grid) # n_grid = 181
